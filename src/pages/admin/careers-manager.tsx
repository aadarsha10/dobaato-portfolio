    ...
    <div className="space-y-8 p-4">
      ...
      <div className="bg-white p-6 shadow rounded grid gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-primary-300" onClick={handleAddOrUpdateJob}>
            {loading ? <Spinner /> : editingJobId ? "Update Job" : "Add Job"}
          </Button>
          {editingJobId && (
            <Button className="border rounded-lg" onClick={handleCancelEditing}>
              Cancel
            </Button>
          )}
        </div>
