...
export default function About() {
	return (
		<section id="about" className="py-24s bg-gray-50 dark:bg-[#10172A] ">
					...
					<div className="flex flex-col md:grid grid-cols-2 gap-6 md:gap-12 mt-12">
						<div className="flex flex-col gap-2">
							...
							<p className="text-[16px] text-gray-700 dark:text-gray-200">
								...
								in Nepal and a global player, delivering
								innovative solutions that redefine industries
								and empower businesses to achieve unprecedented
								growth and success.
							</p>
						</div>
						<div className="flex flex-col gap-2">
							...
							<p className="text-[16px] text-gray-700 dark:text-gray-200">
								Our mission is to redefine IT services in Nepal
								and expand our global footprint with impactful
								solutions.
							</p>
						</div>
					</div>
