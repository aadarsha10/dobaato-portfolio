    ...
    <section id="about" className="py-24 bg-gray-50 dark:bg-[#10172A]">
      ...
      <div className="flex flex-col gap-6 px-6  md:flex-row w-full md:w-[60%]  items-center justify-between md:mx-auto pl-6 md:pl-4 ">
        <p className="text-gray-800 dark:text-gray-200 text-[20px] mx-auto mt-12 w-full md:w-[65%]">
          ...
          years of collective experience, our seasoned team delivers innovative
          solutions at the crossroads of technology. Our mission is to redefine
          IT services in Nepal and expand our global footprint with impactful
          solutions.
        </p>
