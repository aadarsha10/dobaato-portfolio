...
export const Feature = ({
	...
	return (
		<div
			className={cn(
				"flex flex-col lg:border-r py-10 relative rounded-sm dark:border-neutral-800 bg-gradient-to-br from-blue-200 to-white dark:from-blue-900 dark:to-neutral-900",
				(index === 0 || index === 4) &&
