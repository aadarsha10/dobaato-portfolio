  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-medium text-gray-500 dark:text-white mb-1">Visit Us</h3>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-medium text-gray-500 dark:text-white mb-1">Call Us</h3>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-medium text-gray-500 dark:text-white mb-1">Email Us</h3>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-medium text-gray-500 dark:text-white mb-1">Working Hours</h3>
